...
$dictionary['dm_DuplicateRules'] = array(
    ...
    'fields' => array (
		...
		'bean_module' => array (
			...
			'options' => 'dedupe_enabled_modules',
			'len' => '255',
			'size' => '20',
			'enforced' => true,
		),
		...
		'dm_duplicaterules_dm_duplicates' => array (
			'name' => 'dm_duplicaterules_dm_duplicates',
			'type' => 'link',
			'relationship' => 'dm_duplicaterules_dm_duplicates',
			'source' => 'non-db',
			'module' => 'dm_Duplicates',
			'bean_name' => false,
			'side' => 'right',
			'vname' => 'LBL_DM_DUPLICATERULES_DM_DUPLICATES_FROM_DM_DUPLICATERULES_TITLE',
			'id_name' => 'dm_duplicaterules_id',
			'link-type' => 'one',
		),
		'dm_duplicaterules_dm_duplicates_name' => array (
			'name' => 'dm_duplicaterules_dm_duplicates_name',
			'type' => 'relate',
			'source' => 'non-db',
		...
		'dm_duplicaterules_id' => array (
			'name' => 'dm_duplicaterules_id',
			'type' => 'id',
			'source' => 'non-db',
			'vname' => 'LBL_MR_DUPLICATERULES_DM_DUPLICATES_FROM_DM_DUPLICATERULES_TITLE_ID',
			'id_name' => 'dm_duplicaterules_id',
			'link' => 'dm_duplicaterules_dm_duplicates',
			'table' => 'dm_duplicates',
			'module' => 'dm_Duplicates',
